...
import type { ApiResponse, OrderDetail, OrderStatus, OrderSummary, PageResponse, Product } from '../types/shop';

type AdminTab = 'orders' | 'vouchers';
    ...
    const fetchOrderDetail = async (code?: string) => {
        ...
        try {
            ...
            if (response.data?.status) {
                setNextOrderStatus(response.data.status);
            }
        } catch (error) {
            console.error(error);
                        ...
                        {orderDetail && (
                            <div className='border bg-white p-5 sm:p-6 shadow-sm'>
                                ...
                                <div className='mt-5 space-y-4 text-sm'>
                                    ...
                                    <div className='border-t border-gray-100 pt-4'>
                                        <p className='text-xs uppercase tracking-[0.16em] text-gray-400'>Cập nhật trạng thái</p>
